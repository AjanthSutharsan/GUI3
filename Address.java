...
public class Address    //public keyword means class is available to other classes in this program
{
    ...
    //constructor method 
    public Address(int houseNumber, String streetName, String village, String townCity, String postCode) 
    {        
    ...
    {
        return this.houseNumber + ", " + this.streetName + ", " +   this.village + ", " + this.townCity + ", " + this.postCode;
    }
    ...
    public String getPostCode() {return village;}
